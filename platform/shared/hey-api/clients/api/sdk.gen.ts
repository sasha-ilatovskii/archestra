...
/**
 * Get visible virtual API keys for an LLM provider API key
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `llmVirtualKey:read`: View LLM virtual keys
 */
export const getVirtualApiKeys = <ThrowOnError extends boolean = false>(options: Options<GetVirtualApiKeysData, ThrowOnError>) => (options.client ?? client).get<GetVirtualApiKeysResponses, GetVirtualApiKeysErrors, ThrowOnError>({ url: '/api/llm-provider-api-keys/{chatApiKeyId}/virtual-keys', ...options });
 ...
 */
export const deleteVirtualApiKey = <ThrowOnError extends boolean = false>(options: Options<DeleteVirtualApiKeyData, ThrowOnError>) => (options.client ?? client).delete<DeleteVirtualApiKeyResponses, DeleteVirtualApiKeyErrors, ThrowOnError>({ url: '/api/llm-provider-api-keys/{chatApiKeyId}/virtual-keys/{id}', ...options });
